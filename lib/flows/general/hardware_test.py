...
class TestDumpFlashImage(test_lib.FlowTestsBaseclass):
  ...
  def testDumpFlash(self):
    """Dump Flash Image."""
    client_mock = DumpFlashImageMock("StatFile", "GetFile", "LoadComponent",
  ...
  def testUnknownChipset(self):
    ...
    client_mock = UnknownChipsetDumpMock("StatFile", "GetFile", "LoadComponent",
                                         "TransferBuffer", "DeleteGRRTempFiles")
  ...
  def testFailedDumpImage(self):
    """Fail to dump flash."""
    client_mock = FailDumpMock("StatFile", "GetFile", "LoadComponent",
                               "TransferBuffer", "DeleteGRRTempFiles")
