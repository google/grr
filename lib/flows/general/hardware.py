...
class DumpFlashImage(transfer.LoadComponentMixin, flow.GRRFlow):
  ...
  def CollectDebugInfo(self, responses):
    """Start by collecting general hardware and PCI devices information."""
    self.CallFlow("ArtifactCollectorFlow",
                  artifact_list=["LinuxHardwareInfo", "PCIDevicesInfoFiles"],
  ...
  def CollectImage(self, responses):
    ...
    if not responses.success:
      ...
      self.CallFlow("GetFile", pathspec=self.state.image_path,
