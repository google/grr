...
class ClientApprovalAuthorizationManager(
  ...
  def CheckApproversForLabel(self, token, client_urn, requester, approvers,
    ...
    """
    auth = self.GetAuthorizationForSubject(label)
    if not auth:
