...
C:\Python36-x64\python.exe -m pip install --upgrade

C:\Python36\python.exe --version || echo "32bit python install failed" && exit /b 1
C:\Python36\python.exe -m pip install --upgrade
