...
powershell -NoProfile -ExecutionPolicy unrestricted -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; (new-object System.Net.WebClient).DownloadFile('https://github.com/google/protobuf/releases/download/v3.6.1/protoc-3.6.1-win32.zip', 'C:\grr_deps\protoc-3.6.1-win32.zip')"
C:\Python27-x64\python.exe -m "zipfile" -e C:\grr_deps\protoc-3.6.1-win32.zip C:\grr_deps\protoc
