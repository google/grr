...
CopyFormController.prototype.onHuntFetched_ = function(response) {
  ...
  var state = hunt.attributes['aff4:flow_state'];

  this.genericHuntArgs = angular.copy(state['value']['args']);
  this.huntRunnerArgs = angular.copy(
      state['value']['context']['value']['args']);
