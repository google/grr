...
describe('"recursive list directory" button', function() {
  ...
  beforeEach(module('/static/angular-components/client/fileview/recursive-list-button.html'));
  beforeEach(module('/static/angular-components/client/fileview/recursive-list-button-modal.html'));
  beforeEach(module(grrUi.client.fileview.module.name));
  ...
  var renderTestTemplate = function(clientId, vfsPath) {
    $rootScope.clientId = clientId || 'C.0000111122223333';
    $rootScope.vfsPath = vfsPath || 'fs/os/c';

    var template = '<grr-recursive-list-button ' +
        'client-id="clientId" vfs-path="vfsPath" />';
  ...
  describe('modal dialog', function() {
    beforeEach(function() {
      ...
      deferred.resolve({
        'ApiVfsRefreshOperation': {
          default: {
            type: 'ApiVfsRefreshOperation',
            value: {}
          }
        },
        'RDFInteger': {
