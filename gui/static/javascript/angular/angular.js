/**
 * @license AngularJS v1.3.2-local+sha.9e30594
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.2-local+sha.9e30594/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.2-local+sha.9e30594',    // all of these placeholder strings will be replaced by grunt's
