		...
		function _fnScrollDraw ( o )
		{
			...
			else
			{
				   ...
				   $(nScrollBody).height() < $(o.nTable).height() )
				{
					...
					o.nTable.style.width = (iSanityWidth-o.iScrollWidth)+"px";
					if ( $(o.nTable).outerWidth() > iSanityWidth-o.iScrollWidth )
					{
						/* Not possible to take account of it */
						o.nTable.style.width = iSanityWidth+"px";
					}
				}
				else
				{
