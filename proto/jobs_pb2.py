...
_GRRMESSAGE_TYPE = descriptor.EnumDescriptor(
  ...
  values=[
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='RDF_VALUE', index=3, number=3,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_HUNTNOTIFICATION_STATUS = descriptor.EnumDescriptor(
  name='Status',
...
_FLOWNOTIFICATION_STATUS = descriptor.EnumDescriptor(
  name='Status',
...
_HUNTNOTIFICATION = descriptor.Descriptor(
...
_FLOWNOTIFICATION = descriptor.Descriptor(
...
_STARTUPINFO = descriptor.Descriptor(
  name='StartupInfo',
...
_MEMORYINFORMATION = descriptor.Descriptor(
...
_SENDFILEREQUEST = descriptor.Descriptor(
...
_RDFVALUE = descriptor.Descriptor(
  name='RDFValue',
  full_name='RDFValue',
  filename=None,
  file=DESCRIPTOR,
...
class StartupInfo(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
...
class MemoryInformation(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
...
class SendFileRequest(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
...
class RDFValue(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
