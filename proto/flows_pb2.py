...
_GUISETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='docs_location', full_name='GUISettings.docs_location', index=1,
