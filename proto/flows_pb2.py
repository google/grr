...
_ARTIFACTCOLLECTORFLOWARGS_DEPENDENCY = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\352\271\313\271\001^Use the knowledgebase as a cache. If knowledgebase isn\'t present, a new one will be populated.'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IGNORE_DEPS', index=1, number=1,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\352\271\313\271\001\024Ignore dependencies.'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FETCH_NOW', index=2, number=2,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\352\271\313\271\0012Fetch only required dependencies for this artifact'),
      type=None),
  ],
  containing_type=None,
  options=None,
...
_FLOWRUNNERARGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001q\022mIf true, all child flow results received with sendreply will be written to the the flow\'s default collection.\030\001')),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\214\001\022\211\001This value is passed to the client during CallClient, and by default will cause the client to enter fastpoll afterprocessing the message.')),
  ],
  extensions=[
  ],
  nested_types=[],
...
_HUNTRUNNERARGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='require_fastpoll', full_name='HuntRunnerArgs.require_fastpoll', index=14,
...
_CSVOUTPUTPLUGINARGS = _descriptor.Descriptor(
  name='CSVOutputPluginArgs',
  full_name='CSVOutputPluginArgs',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='output_dir', full_name='CSVOutputPluginArgs.output_dir', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\237\001\n\006RDFURN\022\222\001AFF4 directory where resulting CSV files will be written to. If unset, results will be written to a file with a unique identifier under aff4:/tmp.\030\001')),
    _descriptor.FieldDescriptor(
      name='export_options', full_name='CSVOutputPluginArgs.export_options', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\023\022\017Export options.\030\001')),
    _descriptor.FieldDescriptor(
      name='convert_values', full_name='CSVOutputPluginArgs.convert_values', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\0017\0223If true, convert values for export-friendly format.\030\002')),
  ],
  extensions=[
  ],
  nested_types=[],
...
_ARTIFACTCOLLECTORFLOWARGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\201\001\022}If True, apply any relevant parser to the collected data. If False, return the raw collected data e.g Files or Registry Keys.\030\001')),
    _descriptor.FieldDescriptor(
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\0011\022-Specifies how dependencies should be handled.\030\001')),
  ],
  extensions=[
  ],
  nested_types=[],
...
_MEMORYCOLLECTORWITHLOCALCOPYDUMPOPTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001s\022oIf true, check for available disk space before doing a local copy. Ignored if the dump option isn\'t local copy.\030\001')),
  ],
  extensions=[
  ],
  nested_types=[],
...
_KNOWLEDGEBASEINITIALIZATIONARGS = _descriptor.Descriptor(
  ...
  serialized_end=31822,
)


_EXPORTHUNTRESULTSFILESASZIPARGS = _descriptor.Descriptor(
  name='ExportHuntResultsFilesAsZipArgs',
  full_name='ExportHuntResultsFilesAsZipArgs',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='hunt_urn', full_name='ExportHuntResultsFilesAsZipArgs.hunt_urn', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\036\n\006RDFURN\022\024The URN of the hunt.')),
    _descriptor.FieldDescriptor(
      name='deduplicate', full_name='ExportHuntResultsFilesAsZipArgs.deduplicate', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001S\0225Deduplicate files in resulting archive using symlinks\"\032Deduplicate (via symlinks)')),
  ],
  extensions=[
  ],
  nested_types=[],
...
_ENDTOENDTESTFLOWARGS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001_\022]List of endtoend test classes to run. If none are specifed, run all automated endtoend tests.')),
  ],
  extensions=[
  ],
  nested_types=[],
...
_DISKVOLUMEINFOARGS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\020\022\016List of paths.')),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\0011\022-Type of path. Only OS is currently supported.\030\002')),
  ],
  extensions=[
  ],
  nested_types=[],
...
_APPLYLABELSTOCLIENTSFLOWARGS = _descriptor.Descriptor(
  name='ApplyLabelsToClientsFlowArgs',
  full_name='ApplyLabelsToClientsFlowArgs',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='clients', full_name='ApplyLabelsToClientsFlowArgs.clients', index=0,
      number=1, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='labels', full_name='ApplyLabelsToClientsFlowArgs.labels', index=1,
...
_CSVOUTPUTPLUGINARGS.fields_by_name['export_options'].message_type = grr.proto.export_pb2._EXPORTOPTIONS
...
DESCRIPTOR.message_types_by_name['CSVOutputPluginArgs'] = _CSVOUTPUTPLUGINARGS
...
DESCRIPTOR.message_types_by_name['ExportHuntResultsFilesAsZipArgs'] = _EXPORTHUNTRESULTSFILESASZIPARGS
...
DESCRIPTOR.message_types_by_name['ApplyLabelsToClientsFlowArgs'] = _APPLYLABELSTOCLIENTSFLOWARGS
...
class CSVOutputPluginArgs(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _CSVOUTPUTPLUGINARGS

  # @@protoc_insertion_point(class_scope:CSVOutputPluginArgs)
...
class UpdateConfigurationArgs(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
...
class ExportHuntResultsFilesAsZipArgs(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _EXPORTHUNTRESULTSFILESASZIPARGS

  # @@protoc_insertion_point(class_scope:ExportHuntResultsFilesAsZipArgs)

class EndToEndTestFlowArgs(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _ENDTOENDTESTFLOWARGS

  # @@protoc_insertion_point(class_scope:EndToEndTestFlowArgs)

class DiskVolumeInfoArgs(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _DISKVOLUMEINFOARGS

  # @@protoc_insertion_point(class_scope:DiskVolumeInfoArgs)

class ApplyLabelsToClientsFlowArgs(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _APPLYLABELSTOCLIENTSFLOWARGS

  # @@protoc_insertion_point(class_scope:ApplyLabelsToClientsFlowArgs)
...
_FLOWRUNNERARGS.fields_by_name['base_session_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001M\n\006RDFURN\022AThe session id for the flow runner. If not specified we make one.\030\002')
...
_FLOWRUNNERARGS.fields_by_name['write_intermediate_results']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001q\022mIf true, all child flow results received with sendreply will be written to the the flow\'s default collection.\030\001')
_FLOWRUNNERARGS.fields_by_name['require_fastpoll'].has_options = True
_FLOWRUNNERARGS.fields_by_name['require_fastpoll']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\214\001\022\211\001This value is passed to the client during CallClient, and by default will cause the client to enter fastpoll afterprocessing the message.')
...
_HUNTRUNNERARGS.fields_by_name['require_fastpoll']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\214\001\022\211\001This value is passed to the client during CallClient, and by default will cause the client to enter fastpoll afterprocessing the message.')
...
_CSVOUTPUTPLUGINARGS.fields_by_name['output_dir'].has_options = True
_CSVOUTPUTPLUGINARGS.fields_by_name['output_dir']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\237\001\n\006RDFURN\022\222\001AFF4 directory where resulting CSV files will be written to. If unset, results will be written to a file with a unique identifier under aff4:/tmp.\030\001')
_CSVOUTPUTPLUGINARGS.fields_by_name['export_options'].has_options = True
_CSVOUTPUTPLUGINARGS.fields_by_name['export_options']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\023\022\017Export options.\030\001')
_CSVOUTPUTPLUGINARGS.fields_by_name['convert_values'].has_options = True
_CSVOUTPUTPLUGINARGS.fields_by_name['convert_values']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\0017\0223If true, convert values for export-friendly format.\030\002')
...
_UPDATECONFIGURATIONARGS.fields_by_name['config']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001#\022!The config to send to the client.')
...
_ARTIFACTCOLLECTORFLOWARGS_DEPENDENCY.values_by_name["USE_CACHED"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\352\271\313\271\001^Use the knowledgebase as a cache. If knowledgebase isn\'t present, a new one will be populated.')
_ARTIFACTCOLLECTORFLOWARGS_DEPENDENCY.values_by_name["IGNORE_DEPS"].has_options = True
_ARTIFACTCOLLECTORFLOWARGS_DEPENDENCY.values_by_name["IGNORE_DEPS"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\352\271\313\271\001\024Ignore dependencies.')
_ARTIFACTCOLLECTORFLOWARGS_DEPENDENCY.values_by_name["FETCH_NOW"].has_options = True
_ARTIFACTCOLLECTORFLOWARGS_DEPENDENCY.values_by_name["FETCH_NOW"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\352\271\313\271\0012Fetch only required dependencies for this artifact')
...
_ARTIFACTCOLLECTORFLOWARGS.fields_by_name['on_no_results_error']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001t\022rIf True, an artifact returning no results will raise a hard error. This is useful where you always expect results.')
_ARTIFACTCOLLECTORFLOWARGS.fields_by_name['apply_parsers'].has_options = True
_ARTIFACTCOLLECTORFLOWARGS.fields_by_name['apply_parsers']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\201\001\022}If True, apply any relevant parser to the collected data. If False, return the raw collected data e.g Files or Registry Keys.\030\001')
_ARTIFACTCOLLECTORFLOWARGS.fields_by_name['max_file_size'].has_options = True
_ARTIFACTCOLLECTORFLOWARGS.fields_by_name['max_file_size']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001T\n\010ByteSize\022FThe maximum size of files we will download in bytes, 100MB by default.\030\001')
_ARTIFACTCOLLECTORFLOWARGS.fields_by_name['dependencies'].has_options = True
_ARTIFACTCOLLECTORFLOWARGS.fields_by_name['dependencies']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\0011\022-Specifies how dependencies should be handled.\030\001')
...
_GLOBARGS.fields_by_name['no_file_type_check']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\234\001\022\227\001Work with all kinds of files - not only with regular ones.NOTE: This is very dangerous and should be used with care, see MemoryCollector as an example.\030\002')
...
_REGISTRYFINDERCONDITION_TYPE.values_by_name["SIZE"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\352\271\313\271\001\nValue size')
...
_MEMORYCOLLECTORWITHLOCALCOPYDUMPOPTION.fields_by_name['check_disk_free_space']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001s\022oIf true, check for available disk space before doing a local copy. Ignored if the dump option isn\'t local copy.\030\001')
...
_COLLECTARTIFACTDEPENDENCIESARGS.fields_by_name['artifact_list']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001E\n\014ArtifactName\0225A list of Artifact names to collect dependencies for.')
_ARTIFACTFALLBACKCOLLECTORARGS.fields_by_name['artifact_name'].has_options = True
_ARTIFACTFALLBACKCOLLECTORARGS.fields_by_name['artifact_name']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\0019\n\014ArtifactName\022)Name of the artifact using this fallback.')
...
_EXPORTHUNTRESULTSFILESASZIPARGS.fields_by_name['hunt_urn'].has_options = True
_EXPORTHUNTRESULTSFILESASZIPARGS.fields_by_name['hunt_urn']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\036\n\006RDFURN\022\024The URN of the hunt.')
_EXPORTHUNTRESULTSFILESASZIPARGS.fields_by_name['deduplicate'].has_options = True
_EXPORTHUNTRESULTSFILESASZIPARGS.fields_by_name['deduplicate']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001S\0225Deduplicate files in resulting archive using symlinks\"\032Deduplicate (via symlinks)')
_ENDTOENDTESTFLOWARGS.fields_by_name['test_names'].has_options = True
_ENDTOENDTESTFLOWARGS.fields_by_name['test_names']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001_\022]List of endtoend test classes to run. If none are specifed, run all automated endtoend tests.')
_DISKVOLUMEINFOARGS.fields_by_name['path_list'].has_options = True
_DISKVOLUMEINFOARGS.fields_by_name['path_list']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\020\022\016List of paths.')
_DISKVOLUMEINFOARGS.fields_by_name['pathtype'].has_options = True
_DISKVOLUMEINFOARGS.fields_by_name['pathtype']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\0011\022-Type of path. Only OS is currently supported.\030\002')
_APPLYLABELSTOCLIENTSFLOWARGS.fields_by_name['clients'].has_options = True
_APPLYLABELSTOCLIENTSFLOWARGS.fields_by_name['clients']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\342\374\343\304\001\013\n\tClientURN')
