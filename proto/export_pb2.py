...
_EXPORTEDMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='annotations', full_name='ExportedMetadata.annotations', index=13,
