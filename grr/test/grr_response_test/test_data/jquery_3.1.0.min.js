...
!function(a, b) {
  ...
  var x = function(a) {
    ...
    function oa(a) {
      return function(b) {
        return 'label' in b && b.disabled === a ||
            'form' in b && b.disabled === a ||
            'form' in b && b.disabled === !1 &&
            (b.isDisabled === a ||
          ...
          (n = g, o = n.documentElement, p = !f(n),
           ...
           (c.matchesSelector = Y.test(
                s = o.matches || o.webkitMatchesSelector ||
                    ...
                    o.msMatchesSelector)) &&
               ja(function(a) {
                 c.disconnectedMatch = s.call(a, '*'), s.call(a, '[s!=\'\']:x'),
                 r.push('!=', N)
               }),
    ...
    d = ga.selectors = {
      ...
      filter: {
        ...
        PSEUDO: function(a, b) {
          var c,
              e = d.pseudos[a] || d.setFilters[a.toLowerCase()] ||
    ...
    g = ga.tokenize = function(a, b) {
      ...
      while (h) {
        c && !(e = Q.exec(h)) ||
            ...
            c = !1,
            (e = R.exec(h)) &&
            (c = e.shift(), f.push({value: c, type: e[0].replace(P, ' ')}),
             h = h.slice(c.length));
        for (g in d.filter)
        ...
        if (c = d.relative[a[i].type])
          ...
          if (c = d.filter[a[i].type].apply(null, a[i].matches), c[u]) {
            ...
            return xa(
                ...
                c, i < e && ya(a.slice(i, e)), e < f && ya(a = a.slice(e)),
                e < f && sa(a))
          }
          m.push(c)
        }
          ...
          if (e[1]) {
            if (b = b instanceof r ? b[0] : b,
                r.merge(
                    this,
                    r.parseHTML(
                        e[1], b && b.nodeType ? b.ownerDocument || b : d, !0)),
  ...
  r.fn.extend({
    ...
    index: function(a) {
      return a ?
          'string' == typeof a ? i.call(r(a), this[0]) :
  ...
  r.Callbacks = function(a) {
    ...
    var b, c, d, e, f = [], g = [], h = -1, i = function() {
      ...
      fireWith: function(a, c) {
        return e ||
                   (c = c || [], c = [a, c.slice ? c.slice() : c], g.push(c),
                    b || i()),
               this
      },
      fire: function() {
                    ...
                    r.each(c, function(c, d) {
                      ...
                      f[d[1]](function() {
                        ...
                        a && r.isFunction(a.promise) ?
                            a.promise().progress(b.notify).done(b.resolve).fail(
                                b.reject) :
                  ...
                  T(a) &&
                      (a.nodeType ?
                           ...
                           Object.defineProperty(
                               a, this.expando, {value: b, configurable: !0}))),
             b
    },
    set: function(a, b, c) {
      ...
      r.extend({
        ...
        dequeue: function(a, b) {
          ...
          'inprogress' === e && (e = c.shift(), d--),
              e &&
              ('fx' === b && c.unshift('inprogress'), delete f.stop,
               e.call(a, g, f)),
              !d && f && f.empty.fire()
        },
      ...
      aa = ['Top', 'Right', 'Bottom', 'Left'], ba = function(a, b) {
        return a = b || a,
               'none' === a.style.display ||
                   '' === a.style.display && r.contains(a.ownerDocument, a) &&
  ...
  var pa = d.documentElement, qa = /^key/,
    ...
    add: function(a, b, c, d, e) {
      ...
      if (q) {
        c.handler && (f = c, c = f.handler, e = f.selector),
            e && r.find.matchesSelector(pa, e), c.guid || (c.guid = r.guid++),
        ...
        for (; i !== this; i = i.parentNode || this)
          if (1 === i.nodeType && (i.disabled !== !0 || 'click' !== a.type)) {
            for (d = [], c = 0; c < h; c++)
              f = b[c], e = f.selector + ' ',
              void 0 === d[e] &&
                  (d[e] = f.needsContext ? r(e, this).index(i) > -1 :
  ...
  r.Event =
    ...
    return this instanceof r.Event ?
        (a && a.type ?
             ...
             this.type = a,
         b && r.extend(this, b), this.timeStamp = a && a.timeStamp || r.now(),
    ...
    off: function(a, b, c) {
      ...
      if (a && a.preventDefault && a.handleObj)
        return d = a.handleObj,
               r(a.delegateTarget)
                   .off(
                       d.namespace ? d.origType + '.' + d.namespace :
                                     d.origType,
  ...
  var xa =
      ...
      ya = /<script|<style|<link/i, za = /checked\s*(?:[^=]|=\s*.checked.)/i,
      Aa = /^true\/(.*)/, Ba = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
  function Ca(a, b) {
  ...
  function Ha(a, b, c, d) {
    ...
    if (m &&
        (e = oa(b, a[0].ownerDocument, !1, a, d), f = e.firstChild,
      ...
      if (i)
        for (k = h[h.length - 1].ownerDocument, r.map(h, Ea), l = 0; l < i; l++)
          j = h[l],
          ja.test(j.type || '') && !V.access(j, 'globalEval') &&
              r.contains(k, j) &&
    ...
    clone: function(a, b, c) {
      ...
      if (b)
        if (c)
          ...
          Fa(a, h);
      return g = la(h, 'script'), g.length > 0 && ma(g, !i && la(a, 'script')),
             h
    },
  ...
  var Ja = /^margin/, Ka = new RegExp('^(' + $ + ')(?!px)[a-z%]+$', 'i'),
      La = function(b) {
  ...
  r.extend({
    ...
    css: function(a, b, c, d) {
          ...
          function(a, b) {
            r.cssHooks[b] = {
              ...
              set: function(a, c, d) {
                var e, f = d && La(a),
                       g = d &&
                    Va(a, b, d, 'border-box' === r.css(a, 'boxSizing', !1, f),
                       f);
      ...
      r.cssHooks.marginLeft = Na(o.reliableMarginLeft, function(a, b) {
        if (b)
          return (parseFloat(Ma(a, 'marginLeft')) ||
  ...
  function db(a, b, c) {
    for (var d, e = (gb.tweeners[b] || []).concat(gb.tweeners['*']), f = 0,
                g = e.length;
         f < g; f++)
    ...
    if (i = !r.isEmptyObject(b), i || !r.isEmptyObject(n)) {
      l && 1 === a.nodeType &&
          (c.overflow = [o.overflow, o.overflowX, o.overflowY],
           ...
           'none' === k &&
               (j ? k = j :
                    (ga([a], !0), j = a.style.display || j,
                     k = r.css(a, 'display'), ga([a]))),
  ...
  function gb(a, b, c) {
    var d, e,
        f = 0, g = gb.prefilters.length, h = r.Deferred().always(function() {
          delete i.elem
        }),
        i =
            function() {
  ...
  r.Animation = r.extend(gb, {
    ...
    tweener: function(a, b) {
      ...
      for (var c, d = 0, e = a.length; d < e; d++)
        c = a[d], gb.tweeners[c] = gb.tweeners[c] || [],
  ...
  r.speed =
    ...
    return r.fx.off || d.hidden ?
               ...
               e.duration :
               e.duration in r.fx.speeds ? r.fx.speeds[e.duration] :
  ...
  r.fx.start =
      function() {
    Za ||
        (Za = a.requestAnimationFrame ? a.requestAnimationFrame(ab) :
    ...
    removeAttr: function(a) {
      ...
      r.each(r.expr.match.bool.source.match(/\w+/g), function(a, b) {
        ...
        ib[b] = function(a, b, d) {
          ...
          return d ||
                     (f = ib[g], ib[g] = e, e = null != c(a, b, d) ? g : null,
                      ib[g] = f),
                 e
        }
      });
      ...
      return 'boolean' == typeof b && 'string' === c ?
          ...
          this.each(function() {
            ...
            if ('string' === c) {
              ...
              void 0 !== a && 'boolean' !== c ||
                  (b = mb(this), b && V.set(this, '__className__', b),
                   this.setAttribute &&
                       this.setAttribute(
                           'class',
                           b || a === !1 ? '' :
          ...
          select: {
            get: function(a) {
              for (var b, c, d = a.options, e = a.selectedIndex,
                             f = 'select-one' === a.type, g = f ? null : [],
                             h = f ? e + 1 : d.length,
                             i = e < 0 ? h : f ? e : 0;
                   i < h; i++)
                if (c = d[i],
                    (c.selected || i === e) && !c.disabled &&
  ...
  r.extend(r.event, {
    ...
    simulate: function(a, b, c) {
      ...
      o.focusin || r.each({focus: 'focusin', blur: 'focusout'}, function(a, b) {
        var c = function(a) {
  ...
  function xb(a, b, c, d) {
    ...
    if (r.isArray(b))
      r.each(b, function(b, e) {
        c || tb.test(a) ?
            d(a, e) :
            xb(a + '[' + ('object' == typeof e && null != e ? b : '') + ']', e,
               c, d)
      });
        ...
        return b ||
                   (o.createHTMLDocument ?
                        (b = d.implementation.createHTMLDocument(''),
                         e = b.createElement('base'), e.href = d.location.href,
                         b.head.appendChild(e)) :
                        b = d),
               f = B.exec(a), g = !c && [],
               f ? [b.createElement(f[1])] :
                   (f = oa([a], b, g), g && g.length && r(g).remove(),
        ...
        r.fn[a] = function(d) {
          return S(this, function(a, d, e) {
            ...
            return void 0 === e ?
                ...
                void (
                    f ? f.scrollTo(
                            c ? f.pageXOffset : e, c ? e : f.pageYOffset) :
                        a[d] = e)
              ...
              r.fn[d] = function(e, f) {
                ...
                return S(this, function(b, c, e) {
                  ...
                  return r.isWindow(b) ?
                      ...
                      (f = b.documentElement,
                       Math.max(
                           b.body['scroll' + a], f['scroll' + a],
                           b.body['offset' + a], f['offset' + a],
                           f['client' + a])) :
