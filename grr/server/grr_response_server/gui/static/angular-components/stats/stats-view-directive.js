 ...
 * @unrestricted
 */
const StatsViewController = class {
  /**
  ...
  constructor($scope, grrRoutingService) {
    ...
    this.grrRoutingService_.uiOnParamsChanged(
        this.scope_, ['name', 'start_time', 'duration', 'client_label'],
        this.onUrlParamsChange_.bind(this));

    this.scope_.$watchGroup(
        [
          'controller.selectionName', 'controller.startTime',
          'controller.duration', 'controller.clientLabel'
        ],
