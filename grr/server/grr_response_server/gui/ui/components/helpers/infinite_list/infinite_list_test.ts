...
describe('InfiniteList', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      imports: [NoopAnimationsModule, InfiniteListModule],
  ...
  it('triggers loadMore when hasMore is true and footer enters view', async () => {
    const fixture = TestBed.createComponent(TestHostComponent);
    fixture.componentInstance.hasMore = true;
    fixture.detectChanges();
  ...
  it('triggers loadMore when footer is in view and hasMore changes to true', async () => {
    const fixture = TestBed.createComponent(TestHostComponent);
