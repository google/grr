...
describe('Status Chip Component', () => {
  ...
  it('shows "Online" for clients last seen up to 15 minutes ago', fakeAsync(() => {
  ...
  it('shows "Offline" for clients last seen more than 15 minutes ago', fakeAsync(() => {
    jasmine.clock().mockDate(new Date('2020-07-01T13:00:00.000')); // July 1, 2020, 13:00:00
  ...
  it('updates the status from "Online" to "Offline" when time crosses the threshold', fakeAsync(() => {
    jasmine.clock().mockDate(new Date('2020-07-01T13:00:00.000')); // July 1, 2020, 13:00:00
    ...
    jasmine.clock().mockDate(new Date('2020-07-01T13:00:01.000')); // July 1, 2020, 13:00:00
    tick(1000);
    fixture.detectChanges();
    expect(fixture.nativeElement.innerText).toContain(STATUS_OFFLINE);
    discardPeriodicTasks();
  ...
  it('updates the status from "Offline" to "Online" when lastSeen updates', fakeAsync(() => {
    jasmine.clock().mockDate(new Date('2020-07-01T13:00:00.000')); // July 1, 2020, 13:00:00
