...
/** Harness for the FlowOutputPluginLogs component. */
export class FlowOutputPluginLogsHarness extends ComponentHarness {
  static hostSelector = 'flow-output-plugin-logs';
