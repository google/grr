...
/** Form that configures a StatMultipleFiles flow. */
@Component({
  selector: 'stat-multiple-files-form',
...
export class StatMultipleFilesForm extends CollectMultipleFilesForm {
  protected override readonly flowType: FlowType = FlowType.STAT_MULTIPLE_FILES;
  ...
  override resetFlowArgs(flowArgs: StatMultipleFilesArgs): void {
    super.resetFlowArgs(flowArgs);
  }

  override convertFlowArgsToFormState(
    flowArgs: StatMultipleFilesArgs,
