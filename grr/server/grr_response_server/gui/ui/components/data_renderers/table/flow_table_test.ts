...
import {FlowDataTableView} from './flow_table';
...
describe('FlowDataTableView component', () => {
  ...
  it('displays translated flow results', () => {
    const fixture = TestBed.createComponent(FlowDataTableView);
