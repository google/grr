...
import {CollectMultipleFilesArgs, CollectMultipleFilesResult, HashMultipleFilesProgress} from '../../../lib/api/api_interfaces';
...
export class HashMultipleFilesDetails extends Plugin {
  ...
  readonly flowProgress$: Observable<HashMultipleFilesProgress> =
      this.flow$.pipe(
          map((flow) => flow.progress as HashMultipleFilesProgress),
      );
