...
describe('app-default-details component', () => {
  ...
  it('displays a dynamic-result-section for the flow result view section', async () => {
    ...
    const section = fixture.debugElement.query(
      By.directive(DynamicResultSection),
    );
    expect(section.componentInstance.section).toEqual(
