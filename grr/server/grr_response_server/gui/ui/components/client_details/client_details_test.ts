...
describe('Client Details Component', () => {
  ...
  it('selects the first option in the timeline by default', () => {
    ...
    const firstOption = fixture.debugElement.queryAll(
  ...
  it('selects the entry specified in sourceFlowId route param', () => {
    ...
    fixture.detectChanges();
    const secondOption = fixture.debugElement.queryAll(
      By.css('mat-list-option'),
    )[1];
  ...
  it('getAccordionButtonState() returns the expected state', () => {
    ...
    let state = component.getAccordionButtonState(
      totalNumElements,
      currentMaxShownElements,
      initialMaxNumElements,
    );
  ...
  it('allows expanding and collapsing of lists on button click', fakeAsync(() => {
    const fixture = TestBed.createComponent(ClientDetails);
    fixture.detectChanges(); // Ensure ngOnInit hook completes.
  ...
  it('clicking on interrogate button starts Interrogate configuration', fakeAsync(() => {
    const fixture = TestBed.createComponent(ClientDetails);
    fixture.detectChanges(); // Ensure ngOnInit hook completes.
    ...
    fixture.debugElement
      .query(By.css('[name="interrogate-button"]'))
      .triggerEventHandler('click', null);

    const clientPageGlobalStore = injectMockStore(ClientPageGlobalStore);
    expect(
      clientPageGlobalStore.startFlowConfiguration,
    ).toHaveBeenCalledOnceWith('Interrogate', {});
    expect(clientPageGlobalStore.scheduleOrStartFlow).toHaveBeenCalledOnceWith(
      {},
    );
  }));
});
