...
describe('OsqueryQueryHelper component', () => {
  ...
  it('should have queryToDisplay$ emit undefined when search is not a valid table name',
      fakeAsync(() => {
        const fixture = constructFixture();
  ...
  it('should have queryToDisplay$ emit proper string when search is a valid table name',
      fakeAsync(() => {
        const fixture = constructFixture();
  ...
  it('should have no elements in filteredCategories$ when search doesn\'t match anything',
      fakeAsync(() => {
        const fixture = constructFixture();
  ...
  it('should have some elements in filteredCategories$ when search matches table names',
      fakeAsync(() => {
        const fixture = constructFixture();
