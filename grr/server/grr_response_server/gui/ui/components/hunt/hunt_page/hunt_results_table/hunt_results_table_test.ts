...
describe('HuntResultsTable', () => {
  ...
  describe('Table row number', () => {
    it('Table shows nothing as no hunt id was specified', () => {
      ...
      expect(fixture.debugElement.query(By.css('.load-more-container')))
          .toBeNull();
    ...
    it('Table shows nothing as the number of results is 0', () => {
      ...
      expect(fixture.nativeElement.innerText)
          .toEqual('There are no results to show');
    });

    it('Table shows nothing as the API call returned 0 results',
       fakeAsync(() => {
         const fixture = TestBed.createComponent(TestHostComponent);
         const component = fixture.componentInstance;
         ...
         expect(fixture.nativeElement.innerText)
             .toEqual(`User results could not be loaded.`);
    ...
    it('Updates the table dynamically after receiving a new totalResultsCount',
       fakeAsync(() => {
         const fixture = TestBed.createComponent(TestHostComponent);
         const component = fixture.componentInstance;
    ...
    it('Shows the available amount of results as rows despite totalResultsCount being bigger',
       fakeAsync(() => {
         const fixture = TestBed.createComponent(TestHostComponent);
         const component = fixture.componentInstance;
         const mockResults = generateResultListFromResult(mockHuntResult, 10);
    ...
    it('Shows the available amount of results as rows despite totalResultsCount being smaller',
       fakeAsync(() => {
         const fixture = TestBed.createComponent(TestHostComponent);
         const component = fixture.componentInstance;
         const mockResults = generateResultListFromResult(mockHuntResult, 10);
    ...
    it('Resets the results count if the huntId or result type change',
       fakeAsync(() => {
         const fixture = TestBed.createComponent(TestHostComponent);
         const component = fixture.componentInstance;
  ...
  describe('Load more', () => {
    ...
    it('Shows the correct total number of items when totalResultsCount and the results count are inconsistent',
       fakeAsync(() => {
         const fixture = TestBed.createComponent(TestHostComponent);
         const component = fixture.componentInstance;
         const mockResults = generateResultListFromResult(mockHuntResult, 10);
         ...
         expect(loadMoreButton.nativeElement.getAttribute('disabled'))
             .toEqual('true');
         expect(loadMoreButton.nativeElement.innerText)
             .toEqual('Nothing more to load');

         const loadMoreSubtitle = fixture.debugElement.query(
             By.css('.load-more-container .subtitle'));
         expect(loadMoreSubtitle).not.toBeNull();
         expect(loadMoreSubtitle.nativeElement.innerText)
             .toEqual('(displaying 10 out of 10 results)');
    ...
    it('is disabled if there are no more items to load', fakeAsync(() => {
         ...
         const loadMoreSubtitle = fixture.debugElement.query(
             By.css('.load-more-container .subtitle'));
         expect(loadMoreSubtitle.nativeElement.innerText)
             .toEqual('(displaying 30 out of 30 results)');
    ...
    it('loads more items after button click', fakeAsync(() => {
         ...
         const loadMoreSubtitle = fixture.debugElement.query(
             By.css('.load-more-container .subtitle'));
         expect(loadMoreSubtitle.nativeElement.innerText)
             .toEqual(`(displaying ${RESULTS_BATCH_SIZE} out of 80 results)`);
         ...
         expect(loadMoreButton.nativeElement.getAttribute('disabled'))
             .toEqual('true');
         expect(loadMoreSubtitle.nativeElement.innerText)
             .toEqual('(displaying 80 out of 80 results)');
  ...
  describe('Table columns', () => {
    ...
    it('correctly renders "FileFinderResult" type results', fakeAsync(() => {
         ...
         expect(rowItem.rowData['hash'] as HexHash)
             .toEqual(jasmine.objectContaining({md5: '85ab21'}));
    ...
    it('correctly renders "ClientSummary" type results', fakeAsync(() => {
         ...
         expect(cells[CellIndexOf.FQDN].innerText.trim())
             .toContain('griffindor.pc');
    ...
    it('correctly renders "ExecutePythonHackResult" type results',
       fakeAsync(() => {
         const fixture = TestBed.createComponent(TestHostComponent);
         const component = fixture.componentInstance;
         const mockUserHuntResult: ApiHuntResult = {
    ...
    it('correctly renders "ExecuteBinaryResponse" type results',
       fakeAsync(() => {
         const fixture = TestBed.createComponent(TestHostComponent);
         const component = fixture.componentInstance;
         const mockHuntResult: ApiHuntResult = {
    ...
    it('correctly renders "ERRORS" results', fakeAsync(() => {
         ...
         expect(cells[CellIndexOf.LOG_MESSAGE].innerText.trim())
             .toContain('fooLog');
         expect(cells[CellIndexOf.BACKTRACE].innerText.trim())
             .toContain('fooTrace');
  ...
  describe('View Details button', () => {
    it('emits an event to the parent component when clicked on a Result row',
       fakeAsync(() => {
         const fixture = TestBed.createComponent(TestHostComponent);
         const component = fixture.componentInstance;
         const mockBaseHuntResult: ApiHuntResult = {
         ...
         const button =
             fixture.nativeElement.querySelector('.view-details-button');
    ...
    it('emits an event to the parent component when clicked on an Error row',
       fakeAsync(() => {
         const fixture = TestBed.createComponent(TestHostComponent);
         const component = fixture.componentInstance;
         const mockHuntError: ApiHuntError = {
