...
/** Harness for the FleetCollectionApprovalForm component. */
export class FleetCollectionApprovalFormHarness extends ComponentHarness {
  static hostSelector = 'fleet-collection-approval-form';
