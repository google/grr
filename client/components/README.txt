...
```
$ python grr/client/components/build_component.py --config grr-server.yaml build grr/client/components/rekall_support/setup.py /tmp/rekall_component.bin
...
```
$ python grr/client/components/build_component.py --config grr-server.yaml sign /tmp/rekall_component.bin
