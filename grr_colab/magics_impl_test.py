...
class GrrSearchClientsImplTest(absltest.TestCase):
  ...
  def testIsDataframe(self):
    ...
    with mock.patch.object(
      ...
      # TODO(user): Add assertDataFrameRowCount() method.
  ...
  def testRelativePath(self):
    ...
    with mock.patch.object(magics_impl._state, 'client', mock_client):
      with mock.patch.object(magics_impl._state, 'cur_dir', '/quux'):
        ...
        mock_client.ls.assert_called_once_with('/quux/foo/bar')
        self.assertFalse(mock_client.cached.ls.called)
  ...
  def testAbsolutePath(self):
    ...
    with mock.patch.object(magics_impl._state, 'client', mock_client):
      with mock.patch.object(magics_impl._state, 'cur_dir', '/quux'):
        ...
        mock_client.ls.assert_called_once_with('/foo/bar')
        self.assertFalse(mock_client.cached.ls.called)
  ...
  def testCurrentPath(self):
    ...
    with mock.patch.object(magics_impl._state, 'client', mock_client):
      with mock.patch.object(magics_impl._state, 'cur_dir', '/quux'):
        ...
        mock_client.ls.assert_called_once_with('/quux')
        self.assertFalse(mock_client.cached.ls.called)
  ...
  def testRelativePath(self):
    ...
    with mock.patch.object(magics_impl._state, 'client', mock_client):
      with mock.patch.object(magics_impl._state, 'cur_dir', '/quux'):
        ...
        mock_client.glob.assert_called_once_with('/quux/foo/bar')
  ...
  def testAbsolutePath(self):
    ...
    with mock.patch.object(magics_impl._state, 'client', mock_client):
      with mock.patch.object(magics_impl._state, 'cur_dir', '/quux'):
        ...
        mock_client.glob.assert_called_once_with('/foo/bar')
...
class GrrHeadImplTest(absltest.TestCase):
  ...
  def testRelativePath(self):
    mock_client = _MockClient()
    mock_client.add_file('/quux/foo/bar', b'foo bar')
    mock_client.cached.add_file('/quux/foo/bar', b'bar foo')
  ...
  def testAbsolutePath(self):
    mock_client = _MockClient()
    mock_client.add_file('/foo/bar', b'foo bar')
    mock_client.cached.add_file('/foo/bar', b'bar foo')
...
class GrrGrepImplTest(absltest.TestCase):
  ...
  def testNoClientSelected(self):
    with self.assertRaises(magics_impl.NoClientSelectedError):
      magics_impl.grr_grep_impl(b'foo', 'bar')
  ...
  def testRelativePath(self):
    ...
    with mock.patch.object(magics_impl._state, 'client', mock_client):
      with mock.patch.object(magics_impl._state, 'cur_dir', '/quux'):
        magics_impl.grr_grep_impl(b'foo bar', 'foo/bar')

        mock_client.grep.assert_called_once_with('/quux/foo/bar', b'foo bar')
  ...
  def testAbsolutePath(self):
    ...
    with mock.patch.object(magics_impl._state, 'client', mock_client):
      with mock.patch.object(magics_impl._state, 'cur_dir', '/quux'):
        ...
        mock_client.grep.assert_called_once_with('/foo/bar', b'foo bar')
  ...
  def testFixedStrings(self):
    ...
    with mock.patch.object(magics_impl._state, 'client', mock_client):
      with mock.patch.object(magics_impl._state, 'cur_dir', '/quux'):
        magics_impl.grr_grep_impl(b'foo bar', '/foo/bar', fixed_strings=True)

        mock_client.fgrep.assert_called_once_with('/foo/bar', b'foo bar')
...
class GrrFgrepImplTest(absltest.TestCase):
  ...
  def testNoClientSelected(self):
    with self.assertRaises(magics_impl.NoClientSelectedError):
      magics_impl.grr_fgrep_impl(b'foo', 'bar')
  ...
  def testRelativePath(self):
    ...
    with mock.patch.object(magics_impl._state, 'client', mock_client):
      with mock.patch.object(magics_impl._state, 'cur_dir', '/quux'):
        magics_impl.grr_fgrep_impl(b'foo bar', 'foo/bar')

        mock_client.fgrep.assert_called_once_with('/quux/foo/bar', b'foo bar')
  ...
  def testRelativePath(self):
    ...
    with mock.patch.object(magics_impl._state, 'client', mock_client):
      with mock.patch.object(magics_impl._state, 'cur_dir', '/quux'):
        ...
        mock_client.wget.assert_called_once_with('/quux/foo/bar')
  ...
  def testAbsolutePath(self):
    ...
    with mock.patch.object(magics_impl._state, 'client', mock_client):
      with mock.patch.object(magics_impl._state, 'cur_dir', '/quux'):
        ...
        mock_client.wget.assert_called_once_with('/foo/bar')
  ...
  def testCached(self):
    ...
    with mock.patch.object(magics_impl._state, 'client', mock_client):
      with mock.patch.object(magics_impl._state, 'cur_dir', '/quux'):
        ...
        mock_client.cached.wget.assert_called_once_with('/foo/bar')
